...
### Висновок
Без IP процесор не зміг би автоматично визначати, яку інструкцію виконувати наступною після того, як функція закінчилась, бо стек би не міг зберігати потрібну (наступну) інструкцію.
